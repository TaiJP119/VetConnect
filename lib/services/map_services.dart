...
import '../features/pet_management/models/auto_complete_result.dart';
...
class MapServices {
  ...
  Future<Map<String, dynamic>> getDirections(
    ...
    var response = await http.get(Uri.parse(url));
    // check whether the API working or not
    ...
    if (json['status'] != 'OK') {
      print(
          'API Error: ${json['status']} - ${json['error_message'] ?? 'No details'}');
    }
